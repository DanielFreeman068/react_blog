...
function App() {
  ...
  return (
    <>
      ...
      <div id="lifestyle">
        <BlogGrid
          featuredPosts={featuredLifestylePosts}
          recentPosts={recentLifestylePosts}
        />
      </div>
      ...
      <div id="technology">
        <BlogGrid
          featuredPosts={featuredTechPosts}
          recentPosts={recentTechPosts}
        />
      </div>
